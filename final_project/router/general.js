...
public_users.get('/author/:author',function (req, res) {
        ...
        // Iterar a través de las claves para encontrar libros del autor especificado
...
public_users.get('/title/:title',function (req, res) {
    ...
    // Iterar a través de las claves para encontrar el libro con el título especificado
    bookKeys.forEach(key => {
